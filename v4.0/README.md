...
If you want to just run the processing system, the `v4release.bit` and `v4release.hwh` files are available for download and you can skip to the [Processing System Instructions](#processing-system-instructions)
