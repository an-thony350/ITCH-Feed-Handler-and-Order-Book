...
async def run_test_table_write(dut, idle_inserter=None, backpressure_inserter=None):
...
async def run_test_table_read(dut, idle_inserter=None, backpressure_inserter=None):
