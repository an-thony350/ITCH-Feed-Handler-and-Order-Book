...
git sparse-checkout set releases/v3.0
git checkout main
```

2. Open Vivado 2023.2
3. In the Tcl Console, enter the following command: `cd <repository path>/releases/v3.0`
...
The notebook used to run this can be found in `v3.0/processing_system`. The following instructions should provide detail on how to use this system.
