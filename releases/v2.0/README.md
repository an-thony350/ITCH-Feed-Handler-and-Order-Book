...
git sparse-checkout set releases/v2.0
git checkout main
```

2. Open Vivado 2023.2
3. In the Tcl Console, enter the following command: `cd <repository path>/releases/v2.0`
...
The notebook used to run this can be found in [`v2.0/processing_system`](releases/v2.0/processing_system). The following instructions should provide detail on how to use this system.
