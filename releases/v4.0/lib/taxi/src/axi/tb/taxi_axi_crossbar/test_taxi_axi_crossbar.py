...
if getattr(cocotb, 'top', None) is not None:
    ...
    data_width = len(cocotb.top.s_axi[0].wdata)
...
async def run_test_write(dut, idle_inserter=None, backpressure_inserter=None, size=None, s=0, m=0):
...
async def run_test_read(dut, idle_inserter=None, backpressure_inserter=None, size=None, s=0, m=0):
